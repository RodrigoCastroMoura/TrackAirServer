...
- **DadosVeiculo**: Todos os protocolos GPS (IMEI, longitude, latitude, altitude, speed, ignicao, dataDevice, data, protocol_type, raw_message, bateria_voltagem, evento_ignicao, comando_executado, cell_id, lac_code)
